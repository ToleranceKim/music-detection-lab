...
특히 Sunday는 Deezer, FakeMusicCaps, SONICS 등 선행 연구에서 공통으로 드러난 긴장 관계를 강조합니다. 한편으로는 창작 접근성을 높이는 긍정적 가능성이 존재하지만, 다른 한편으로는 플랫폼 차원에서 딥페이크를 탐지하고 관리하는 기술적 수단이 없으면 음악 생태계 전반의 신뢰가 훼손될 수 있다는 점을 반복해서 지정합니다.
---
...
Sunday는 이 가운데 딥페이크 5,373개를 무작위로 선택해 사랍 5,373개와 짝을 맞추고, 총 10,746개의 샘플을 사람 대 딥페이크 이진 분류 문제로 재구성합니다.
